...
def test_maps_list_condition() -> None:
    ...
    response = client.get('/maps/condition?country=si')
    assert response.status_code == 200

    response = client.get('/maps/condition?country=de')
    assert response.status_code == 200


def test_maps_list_precipitation() -> None:
    """Test maps list - precipitation."""
    response = client.get('/maps/precipitation?country=si')
    assert response.status_code == 200

    response = client.get('/maps/precipitation?country=de')
    assert response.status_code == 200


def test_maps_list_cloud() -> None:
    """Test maps list - cloud."""
    response = client.get('/maps/cloud?country=si')
    assert response.status_code == 200


def test_maps_list_wind() -> None:
    """Test maps list - wind."""
    response = client.get('/maps/wind?country=si')
    assert response.status_code == 200


def test_maps_list_temperature() -> None:
    """Test maps list - temperature."""
    response = client.get('/maps/temperature?country=si')
    assert response.status_code == 200


def test_maps_list_hail() -> None:
    """Test maps list - hail."""
    response = client.get('/maps/hail?country=si')
    assert response.status_code == 200
...
def test_maps_invalid() -> None:
    ...
    response = client.get('/maps/invalid?country=si')
...
def test_maps_no_country() -> None:
    ...
    response = client.get('/maps/condition')
    assert response.status_code == 422
